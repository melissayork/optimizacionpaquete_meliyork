...
from .funcionesPrueba.funcionesMultivariables import rastrigin, ackley, himmelblau, sphere, rosenbrock,  beale, goldstein, booth, bunkin, matyas, levi, threehumpcamel,easom,crossintray, eggholder, holdertable, mccormick, schaffer2, schaffer_n4,  styblinskitang, shekel  
